    ...
    <section id="pricing" ref={ref} className="relative py-28 px-6 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        w-[600px] h-[400px] rounded-full bg-blue-500/5 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          {plans.map((plan, i) => {
            ...
            return (
              <div key={plan.key}
                className={`reveal ${delays[i]} relative flex flex-col rounded-3xl p-8
                            border transition-all duration-300 hover:-translate-y-1 ${
                  meta.highlight
                    ? "bg-blue-500/10 border-blue-500/40 shadow-2xl shadow-blue-500/20"
                    : "bg-[#0c0f1a] border-white/[0.08] hover:border-white/[0.15]"
                }`}>
                ...
                {meta.badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2
                                  ...
                                  px-4 py-1.5 rounded-full shadow-lg shadow-blue-500/40">
                  ...
                  {plan.price ? (
                    <div className="flex items-end gap-1">
                      ...
                      <span className={`text-4xl font-bold leading-none ${
                        meta.highlight ? "text-blue-300" : "text-white"
                      }`}>
                  ...
                  {(meta.features || []).map((f, j) => (
                    <li key={j} className="flex items-start gap-3">
                      <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                        meta.highlight ? "bg-blue-500/30" : "bg-blue-500/15"
                      }`}>
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-2xl font-semibold text-sm transition-all duration-300 ${
                    meta.highlight
                      ? "bg-blue-500 hover:bg-blue-400 text-white shadow-lg shadow-blue-500/30 hover:-translate-y-0.5"
