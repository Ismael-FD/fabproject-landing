    ...
    <section id="hero" ref={ref}
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        ...
                        bg-brand-500/10 blur-[140px] animate-glow-pulse" />
        <div className="absolute top-1/4 right-1/4
                        w-[300px] h-[300px] rounded-full
                        bg-brand-400/5 blur-[80px]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <div data-reveal style={{ opacity: 0, transform: "translateY(20px)", transition: "all 0.6s ease" }}
          className="inline-flex items-center gap-2 bg-brand-500/10 border border-brand-500/20
                     text-brand-400 text-xs font-semibold tracking-widest uppercase
        ...
        <div data-reveal style={{ opacity: 0, transform: "translateY(20px)", transition: "all 0.6s ease" }}
          ...
          <button onClick={() => scrollTo("#pricing")}
            className="group flex items-center gap-2 bg-brand-500 hover:bg-brand-400
      ...
      <div data-reveal style={{ opacity: 0, transform: "translateY(20px)", transition: "all 0.8s ease" }}
        ...
        <div className="relative bg-[#111827] border border-white/8 rounded-3xl p-1
        ...
        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2
                        w-3/4 h-12 bg-brand-500/20 blur-2xl rounded-full" />
      </div>
    </section>
  );
}
